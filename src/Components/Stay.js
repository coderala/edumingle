...
const Stay = () => {
  return (
    <div className="container mx-auto">
      <div className="bg-light rounded-xl  text-center xl:space-y-5 lg:flex py-6 px-3">
        {/* first div  */}
        ...
        <div className="flex flex-col justify-center  lg:w-6/12 lg:text-start">
          <div className="flex flex-col space-y-4 justify-center lg:text-start  lg:ml-10 lg:space-y-5">
            ...
            <div className="relative flex flex-col justify-center items-center lg:w-11/12 xl:w-10/12">
              <FontAwesomeIcon
                icon={faEnvelope}
